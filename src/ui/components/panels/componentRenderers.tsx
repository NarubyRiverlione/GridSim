/**
 * Individual component detail renderers
 */

import React from 'react'
import type { PowerPlant, City, TransmissionLine, Substation, SwitchingStation, Pylon } from '@/types'
...
export const DetailRow = ({ label, value }: DetailRowProps): React.ReactElement => (
...
export const renderPowerPlantDetails = (plant: PowerPlant): React.ReactElement => (
...
export const renderCityDetails = (city: City): React.ReactElement => (
  <div className="detail-section">
...
export const renderTransmissionLineDetails = (line: TransmissionLine): React.ReactElement => (
  <div className="detail-section">
...
export const renderSubstationDetails = (substation: Substation): React.ReactElement => (
  <div className="detail-section">
...
export const renderSwitchingStationDetails = (station: SwitchingStation): React.ReactElement => {
...
export const renderPylonDetails = (pylon: Pylon): React.ReactElement => {
